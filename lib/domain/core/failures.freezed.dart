...
// ignore: unused_element
  InvalidGeoPoint<T> invalidGeoPoint<T>({@required T failedValue}) {
    return InvalidGeoPoint<T>(
      failedValue: failedValue,
    );
  }
}
...
mixin _$ValueFailure<T> {
  ...
  Result maybeMap<Result extends Object>({
    ...
    Result invalidGeoPoint(InvalidGeoPoint<T> value),
    @required Result orElse(),
  });
...
abstract class $InvalidGeoPointCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
...
class _$InvalidGeoPointCopyWithImpl<T, $Res>
    extends _$ValueFailureCopyWithImpl<T, $Res>
    implements $InvalidGeoPointCopyWith<T, $Res> {
  _$InvalidGeoPointCopyWithImpl(
      InvalidGeoPoint<T> _value, $Res Function(InvalidGeoPoint<T>) _then)
      : super(_value, (v) => _then(v as InvalidGeoPoint<T>));

  @override
  InvalidGeoPoint<T> get _value => super._value as InvalidGeoPoint<T>;

  @override
  $Res call({
    Object failedValue = freezed,
  }) {
    return _then(InvalidGeoPoint<T>(
      failedValue:
          failedValue == freezed ? _value.failedValue : failedValue as T,
    ));
  }
...
class _$InvalidGeoPoint<T> implements InvalidGeoPoint<T> {
  const _$InvalidGeoPoint({@required this.failedValue})
      : assert(failedValue != null);
  ...
  $InvalidGeoPointCopyWith<T, InvalidGeoPoint<T>> get copyWith =>
      _$InvalidGeoPointCopyWithImpl<T, InvalidGeoPoint<T>>(this, _$identity);
...
abstract class InvalidGeoPoint<T> implements ValueFailure<T> {
  const factory InvalidGeoPoint({@required T failedValue}) =
      _$InvalidGeoPoint<T>;
