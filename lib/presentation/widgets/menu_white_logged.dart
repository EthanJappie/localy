...
class Menuwhitenotlogged extends StatelessWidget {
  const Menuwhitenotlogged({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 192.0, 103.0, 12.0),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 236.0, 74.0, 12.0),
                    size: Size(151.0, 292.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Discounts' (text)
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 280.0, 77.0, 12.0),
                    size: Size(151.0, 292.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Discounts' (text)
