...
class Myaddressesempty extends StatelessWidget {
  const Myaddressesempty({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(68.0, 18.0, 73.0, 12.0),
                    size: const Size(375.0, 68.0),
                    child: Transform.rotate(
                      angle: 0.0,
                      child:
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(67.6, 38.0, 114.0, 14.0),
                    size: const Size(375.0, 68.0),
                    child: Transform.rotate(
                      angle: 0.0,
                      child:
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(317.6, 28.0, 27.0, 14.0),
                    size: const Size(375.0, 68.0),
                    child: Transform.rotate(
                      angle: 0.0,
                      child:
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(68.0, 18.0, 77.0, 12.0),
                    size: const Size(375.0, 68.0),
                    child: Transform.rotate(
                      angle: 0.0,
                      child:
