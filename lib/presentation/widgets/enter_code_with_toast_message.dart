...
class Entercodewithtoastmessage extends StatelessWidget {
  const Entercodewithtoastmessage({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(107.0, 18.0, 102.0, 14.0),
                    size: const Size(315.0, 48.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: const Rect.fromLTWH(0.0, 0.0, 102.0, 14.0),
                          size: const Size(102.0, 14.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
          ...
          Transform.translate(
            offset: const Offset(117.0, 403.0),
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(0.0, 0.0, 142.0, 30.0),
                    size: const Size(142.0, 30.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: const Rect.fromLTWH(12.0, 10.0, 112.0, 12.0),
                          size: const Size(142.0, 30.0),
                          pinLeft: true,
                          pinRight: true,
                          fixedHeight: true,
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(235.0, 38.0, 6.0, 15.0),
                    size: const Size(375.0, 73.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: const Text(
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(145.0, 38.0, 6.0, 15.0),
                    size: const Size(375.0, 73.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: const Text(
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(55.0, 38.0, 6.0, 15.0),
                    size: const Size(375.0, 73.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(315.0, 38.0, 6.0, 15.0),
                    size: const Size(375.0, 73.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
