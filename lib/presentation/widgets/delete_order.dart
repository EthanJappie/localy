          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(9.0, 125.0, 222.0, 40.0),
                    size: Size(240.0, 165.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 240.0, 102.0),
                    size: Size(240.0, 165.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(53.3, 31.9, 54.9, 82.4),
                    size: Size(161.8, 114.3),
                    child: SvgPicture.string(
                      _svg_2or7by,
                      allowDrawingOutsideViewBox: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(96.0, 18.0, 124.0, 14.0),
                    size: Size(315.0, 48.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(99.0, 17.0, 118.0, 16.0),
                    size: Size(315.0, 46.0),
                    fixedHeight: true,
                    child:
