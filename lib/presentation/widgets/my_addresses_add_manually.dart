...
class Myaddressesaddmanually extends StatelessWidget {
  const Myaddressesaddmanually({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(110.0, 17.0, 96.0, 16.0),
                    size: const Size(315.0, 46.0),
                    fixedHeight: true,
                    child:
          ...
          Transform.translate(
            offset: const Offset(30.0, 369.0),
            child:
                // Adobe XD layer: 'Check make default' (group)
                SizedBox(
              width: 222.0,
              height: 22.0,
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(32.0, 5.0, 190.0, 14.0),
                    size: const Size(222.0, 22.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(0.0, 0.0, 22.0, 22.0),
                    size: const Size(222.0, 22.0),
                    child: Stack(
                      children: <Widget>[
                        SvgPicture.string(
          ...
          Transform.translate(
            offset: const Offset(0.0, 279.0),
            child:
                // Adobe XD layer: 'Address name' (group)
                SizedBox(
              width: 375.0,
              height: 60.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(30.0, 31.0, 247.0, 15.0),
                    size: const Size(375.0, 60.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'text' (text)
                        const Text(
                      'Enter the address name (work, home)',
                      style: TextStyle(
                        fontFamily: 'SF Pro Text',
                        fontSize: 15,
          ...
          Transform.translate(
            offset: const Offset(0.0, 219.0),
            child:
                // Adobe XD layer: 'Complete address fi…' (group)
                SizedBox(
              width: 375.0,
              height: 60.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(30.0, 31.0, 274.0, 15.0),
                    size: const Size(375.0, 60.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'text' (text)
                        const Text(
                      'Enter the complete address (floor, app no)',
                      style: TextStyle(
                        fontFamily: 'SF Pro Text',
                        fontSize: 15,
                        color: Color(0x80242134),
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(30.0, 31.0, 217.0, 15.0),
                    size: const Size(375.0, 60.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'text' (text)
                        const Text(
                      'Bulevardul Dimitrie Cantemir 49B',
                      style: TextStyle(
                        fontFamily: 'SF Pro Text',
                        fontSize: 15,
                        color: Color(0xff1a1824),
...
const String _svg_mfp5ff =
    '<svg viewBox="0.0 0.0 22.0 22.0" ><path transform="translate(0.0, 0.0)" d="M 11 0 C 17.07513236999512 0 22 4.924867630004883 22 11 C 22 17.07513236999512 17.07513236999512 22 11 22 C 4.924867630004883 22 0 17.07513236999512 0 11 C 0 4.924867630004883 4.924867630004883 0 11 0 Z" fill="#ffffff" stroke="#d0d0d2" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
