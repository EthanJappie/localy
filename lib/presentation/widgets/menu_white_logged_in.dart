...
class Menuwhiteloggedin extends StatelessWidget {
  const Menuwhiteloggedin({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'Scaled viewport' (group)
                SizedBox(
              width: 150.0,
              height: 634.0,
              child: Stack(
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(0.0, 328.0, 103.0, 12.0),
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(0.0, 372.0, 74.0, 12.0),
                    size: const Size(175.0, 428.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Discounts' (text)
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(0.0, 416.0, 77.0, 12.0),
                    size: const Size(175.0, 428.0),
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'Discounts' (text)
