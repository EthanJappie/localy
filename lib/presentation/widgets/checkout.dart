    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: const Offset(76.0, 559.0),
            child:
          ...
          Transform.translate(
            offset: const Offset(94.0, 592.0),
            child:
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(294.0, 28.0, 51.0, 14.0),
                    size: const Size(375.0, 68.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(30.0, 40.0, 99.0, 12.0),
                    size: const Size(375.0, 68.0),
                    child: Transform.rotate(
                      angle: 0.0,
                      child:
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(30.0, 18.0, 122.0, 14.0),
                    size: const Size(375.0, 68.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
