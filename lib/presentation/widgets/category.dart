    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(101.0, 1753.0, 134.0, 5.0),
                    size: const Size(340.3, 1758.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            offset: const Offset(30.0, 1384.0),
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(0.0, 291.0, 315.0, 14.0),
                    size: const Size(315.0, 335.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(0.0, 0.0, 315.0, 240.0),
                    size: const Size(315.0, 335.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    ...
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: const Rect.fromLTWH(128.0, 96.0, 60.0, 47.6),
                          size: const Size(315.0, 240.0),
                          child:
          ...
          Transform.translate(
            offset: const Offset(30.0, 1009.0),
            child:
          ...
          Transform.translate(
            offset: const Offset(30.0, 634.0),
            child:
          ...
          Transform.translate(
            offset: const Offset(30.0, 259.0),
            child:
