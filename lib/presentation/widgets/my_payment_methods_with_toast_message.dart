...
class Mypaymentmethodswithtoastmessage extends StatelessWidget {
  const Mypaymentmethodswithtoastmessage({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(89.0, 17.0, 138.0, 16.0),
                    size: const Size(315.0, 46.0),
                    fixedHeight: true,
                    child:
          ...
          Transform.translate(
            offset: const Offset(88.0, 642.0),
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(12.0, 10.0, 163.0, 12.0),
                    size: const Size(199.0, 30.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(68.0, 40.0, 76.0, 12.0),
                    size: const Size(375.0, 68.0),
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(68.0, 18.0, 122.0, 14.0),
                    size: const Size(375.0, 68.0),
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(304.0, 28.0, 41.0, 14.0),
                    size: const Size(375.0, 68.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(30.0, 23.0, 22.0, 22.0),
                    size: const Size(375.0, 68.0),
                    child: Stack(
                      children: <Widget>[
                        SvgPicture.string(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(68.0, 40.0, 63.0, 12.0),
                    size: const Size(375.0, 68.0),
                    child: Transform.rotate(
                      angle: 0.0,
                      child:
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(68.0, 40.0, 99.0, 12.0),
                    size: const Size(375.0, 68.0),
                    child: Transform.rotate(
                      angle: 0.0,
                      child:
                  ...
                  Pinned.fromSize(
                    bounds: const Rect.fromLTWH(36.0, 30.0, 10.0, 8.1),
                    size: const Size(375.0, 68.0),
                    child:
...
const String _svg_rioysx =
    '<svg viewBox="0.0 342.0 375.0 68.0" ><path transform="translate(0.0, 342.0)" d="M 0 0 L 375 0 L 375 68 L 326.5131225585938 68 L 313.1427612304688 68 L 309.880859375 68 L 0 68 L 0 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_rnfkk6 =
    '<svg viewBox="0.0 0.0 22.0 22.0" ><path transform="translate(0.0, 0.0)" d="M 11 0 C 17.07513236999512 0 22 4.924867630004883 22 11 C 22 17.07513236999512 17.07513236999512 22 11 22 C 4.924867630004883 22 0 17.07513236999512 0 11 C 0 4.924867630004883 4.924867630004883 0 11 0 Z" fill="none" stroke="#d0d0d2" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_ectoi7 =
    '<svg viewBox="0.0 274.0 375.0 68.0" ><path transform="translate(0.0, 274.0)" d="M 0 0 L 375 0 L 375 68 L 326.5131225585938 68 L 313.1427612304688 68 L 309.880859375 68 L 0 68 L 0 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_ncj629 =
    '<svg viewBox="0.0 206.0 375.0 68.0" ><path transform="translate(0.0, 206.0)" d="M 0 0 L 375 0 L 375 68 L 326.5131225585938 68 L 313.1427612304688 68 L 309.880859375 68 L 0 68 L 0 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_c97jsc =
    '<svg viewBox="0.0 0.0 22.0 22.0" ><path transform="translate(0.0, 0.0)" d="M 11 0 C 17.07513236999512 0 22 4.924867630004883 22 11 C 22 17.07513236999512 17.07513236999512 22 11 22 C 4.924867630004883 22 0 17.07513236999512 0 11 C 0 4.924867630004883 4.924867630004883 0 11 0 Z" fill="#34c47c" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_n7kggz =
    '<svg viewBox="36.0 236.0 10.0 8.1" ><path transform="translate(36.0, 202.71)" d="M 8.471858978271484 33.2859992980957 L 3.47184419631958 38.28490447998047 L 1.528229355812073 36.34190368652344 L 0 37.87010192871094 L 3.47187328338623 41.34148025512695 L 10 34.81422805786133 L 8.471858978271484 33.2859992980957 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
