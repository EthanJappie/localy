...
abstract class StoreFormEvent with _$StoreFormEvent {
  const factory StoreFormEvent.initialized(
      Option<Restaurant> initialStoreOption) = _Initialized;
  ...
  const factory StoreFormEvent.coverImageChanged(String coverImage) =
      _CoverImageChanged;

  const factory StoreFormEvent.deliveryCostChanged(double deliveryCosts) =
      _DeliveryCostChanged;
}
