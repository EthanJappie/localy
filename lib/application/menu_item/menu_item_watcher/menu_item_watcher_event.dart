...
abstract class MenuItemWatcherEvent with _$MenuItemWatcherEvent {
  const factory MenuItemWatcherEvent.watchAllStarted(
    String menuID,
  ) = _WatchAllMenuItemsStarted;

  const factory MenuItemWatcherEvent.watchAllUnhidden(
    String menuID,
  ) = _WatchAllMenuItemsUnhidden;
